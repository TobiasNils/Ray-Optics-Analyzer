    ...
    **ARGUMENTS:**
    ...
    property material:
        ...
        def __set__(self,material):
            assert isinstance(material,(float,Material)),"material must be a floating point number or a Material instance"
    ...
    cpdef distance(self, Ray ri_):
        ...
        *Return value*
        ...
        # get index of minimally distant ray-surface intersectin
